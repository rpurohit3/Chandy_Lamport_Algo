...
public class ChandyLamportProcess extends UnicastRemoteObject implements
	...
	public ChandyLamportProcess() throws RemoteException, UnknownHostException {
        ...
        */
		...
		processesID.put(1, "ANKUL-PC");
		processesID.put(0, "DELL");
		processesID.put(2, "RUDRA-PC");
...
*/
		...
		if (InetAddress.getLocalHost().getHostName().equals("RUDRA-PC")) {
			ID = 2;
		} else if (InetAddress.getLocalHost().getHostName().equals("ANKUL-PC")) {
			ID = 1;
...
*/
        processes.put("ANKUL-PC", "128.61.31.94");
		processes.put("DELL", "143.215.95.234");
		processes.put("RUDRA-PC", "143.215.82.182");
